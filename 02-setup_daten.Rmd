...
Diese Beispielanalyse basiert auf [*R-Markdown-Dateien*](https://rmarkdown.rstudio.com/). Ich schätze R-Markdown, weil die Kombination von Fließtext, Code und Output eine für andere gut nachvollziehbare Arbeitsweise und ein replizierbares Analyseergebnis gewährleistet. R-Markdown bietet vielfältige Ausgabeformate an. Ich entscheide mich hier für ein gitbook, weil ich so auch interaktive Visualisierungen mit `plotly` nutzen kann. Gemeinsam mit `plotly` lade ich weitere Pakete in meinen workspace.
